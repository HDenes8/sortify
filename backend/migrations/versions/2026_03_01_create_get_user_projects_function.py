"""Create get_user_projects stored procedure

Revision ID: 2026_03_01_001
Revises: e2e3385983bc
Create Date: 2026-03-01 11:36:00.000000
...
down_revision = 'e2e3385983bc'
branch_labels = None
depends_on = None


def upgrade():
    # Create the get_user_projects stored procedure
    op.execute("""
...
def downgrade():
    ...
    op.execute("DROP FUNCTION IF EXISTS public.get_user_projects(integer)")
